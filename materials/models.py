...
class Material(AbstractEntity):
    ...
    unit = models.CharField(max_length=256, help_text='主计量单位', null=True, blank=True)
    quantity = models.IntegerField(help_text='数量', null=True, blank=True)
    tax_unit_price = models.FloatField(help_text='含税单价', null=True, blank=True)
    unit_price = models.FloatField(help_text='单价', null=True, blank=True)
    amount = models.FloatField(help_text='金额', null=True, blank=True)
    total_value_tax = models.FloatField(help_text='价税合计', null=True, blank=True)
    ...
    requirement_desc = models.CharField(max_length=256, help_text='需求说明', null=True, blank=True)
    ...
    unbilled = models.IntegerField(help_text='未开票数量', null=True, blank=True)
    cumulative_billed = models.IntegerField(help_text='累计开票数量', null=True, blank=True)
